...
import { EVENT, ROUND_NUMBERS, ROUNDS } from '../config/gameContent.js';
...
export default function HostDashboard({ state }) {
  ...
  async function restart() {
    if (!window.confirm('Play again? Everyone stays in the game, but ALL answers and scores are cleared.')) return;
